...
<div id="container-wrap">
	...
	<div class="mypage-header" style="text-align: left;">
			<h4 class="content-h4">회원 관리</h4>
		</div>
		<ul class="info-text">
			<li style="color: red;">해당 회원 관리 페이지는  관리자 만 열람 가능합니다.</li>
			<li style="color: red;">회원의 정보를 수정하거나 삭제할 수 있습니다.</li>
			<li style="color: #333;">간편 로그인 회원은 Naver_ , Kakao_ , Google_ 등 으로 표기됩니다.</li>
		</ul>
		...
		<c:if test="${list != null && list.size() >= 1}">
			<c:forEach var="item" items="${list}">
					<tr class="mypage-trHover">
						...
						<td>${item.userPw}</td>
						<td>
							<a href="/user/${item.userId}/update" class="r-link state" style="cursor:pointer;">수정 </a>
							<span style="color: #777777; margin: 0 5px;">|</span>
							<a href="/user/${item.userId}/delete" class="r-link state" style="cursor:pointer;">삭제</a>
						</td>
					</tr>
			</c:forEach>
		</c:if>
