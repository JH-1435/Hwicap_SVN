...
<script src="/js/CKEDITOR_5_keycap_update.js"></script>
<script type="text/javascript">	
function submitForm() {
	$('#keycapUpdateForm').submit();
}
...
<div id="container-wrap">
		<div class="contents">
			...
			<div class="mypage-header" style="text-align: left;">
				<h4 class="content-h4">상품 수정</h4>
			</div>
				<form id="keycapUpdateForm" method="post" action="" enctype="multipart/form-data">
					...
					<tr style="text-align: left; border-bottom: 1px solid #000000;">
						...
						<td style="border-bottom: 1px solid #000000; text-align: left;">
							...
							<div class="photo-big">
								<ul style="padding: 0;">
									<li>
									<img id="preview" src="/HwicapUpload/${item.keycapImg}" alt="썸네일" class="photo-img"/>
									</li>
								</ul>
							</div>
							</div>
					...
					<tr style="text-align: left; border-bottom: 1px solid #000000;">
						...
						<tr style="text-align: left; border-bottom: 1px solid #000000;">
							...
							<td style="text-align: left; border-bottom: none; width: 100%; padding: 15px;">
							      <input class="boardTitle" type="radio" name="keycapCategory" value="키캡" <c:if test="${item.keycapCategory eq '키캡'}">checked</c:if>/>
							      <label for="keycap">키캡</label>
							      <input class="boardTitle" type="radio" name="keycapCategory" value="기타" <c:if test="${item.keycapCategory eq '기타'}">checked</c:if>/>
						...
						<tr style="text-align: left; border-bottom: 1px solid #000000;">
							...
							<td style="border-bottom: 1px solid #000000; text-align: left;">
								<input name="keycapStock" type="number" style="width: 400px;" value="${item.keycapStock}"> 개
							</td>
						</tr>
						<tr style="text-align: left; border-bottom: 1px solid #000000;">
							<th style="padding-left: 40px; background: #f7f8f9;">가격</th>
							<td style="border-bottom: 1px solid #000000; text-align: left;">
								<input name="keycapPrice" type="number" style="width: 400px;" value="${item.keycapPrice}"> 원
							</td>
						</tr>
						<tr style="text-align: left; border-bottom: 1px solid #000000;">
							<th style="padding-left: 40px; background: #f7f8f9;">상세내용</th>
							<td style="border-bottom: none; width: 100%;">
								<textarea rows="200" cols="200" name="keycapContent" id="keycapContent" maxlength="2048">
									${item.keycapContent} <!-- ckEditor5 에서 불러올 값 -->
								</textarea>
							</td>
						</tr>
					</tbody>
				...
				<div class="overflow-hidden">
					<div class="btn-group">
						...
						<a onclick="event.preventDefault(); submitForm();" class="end-btn">상품수정</a>
